...
SUBDIRS = libltdl include openssl ldap lib scepd scep cgi-bin doc 		html man package rpm
...
Makefile.in NEWS TODO acconfig.h aclocal.m4 config.guess config.sh.in \
